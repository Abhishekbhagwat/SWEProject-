...
import './App.css';
import N27_PaymentDetailsScreen from './N27_PaymentDetailsScreen.js';
import N13_NavigationMenuScreen from './N13_NavigationMenuScreen.js';
import N26_CheckoutScreen from './N26_CheckoutScreen.js';
import CartScreen from './CartScreen.js';
import N22_ProductDetailsScreen from './N22_ProductDetailsScreen.js';
import NorthSpineScreen from './NorthSpineScreen.js';
import N30_GalleryCategoryScreen from './N30_GalleryCategoryScreen.js';
import N4_SignUpScreen from './N4_SignUpScreen.js';
import N3_SignInScreen from './N3_SignInScreen.js';
import N2_StartPageScreen from './N2_StartPageScreen.js';
import N1_WelcomeScreen from './N1_WelcomeScreen.js';
import MessagesScreen from './MessagesScreen.js';
import N12_EditUserProfileScreen from './N12_EditUserProfileScreen.js';
  ...
  render() {
    let makeElementForScreen = (screenId, baseProps, atTop, forward) => {
      ...
      switch (screenId) {
        default:
          return null;
        case 'n27_paymentdetails':
          return (<N27_PaymentDetailsScreen {...screenProps} />)
        case 'n13_navigationmenu':
          return (<N13_NavigationMenuScreen {...screenProps} />)
        case 'n26_checkout':
          return (<N26_CheckoutScreen {...screenProps} />)
        case 'cart':
          return (<CartScreen {...screenProps} />)
        case 'n22_productdetails':
          return (<N22_ProductDetailsScreen {...screenProps} />)
        case 'northspine':
          return (<NorthSpineScreen {...screenProps} />)
        case 'n30_gallerycategory':
          return (<N30_GalleryCategoryScreen {...screenProps} />)
        case 'n4_signup':
          return (<N4_SignUpScreen {...screenProps} />)
        case 'n3_signin':
          return (<N3_SignInScreen {...screenProps} />)
        case 'n2_startpage':
          return (<N2_StartPageScreen {...screenProps} />)
        case 'n1_welcome':
          return (<N1_WelcomeScreen {...screenProps} />)
        case 'messages':
          return (<MessagesScreen {...screenProps} />)
        case 'n12_edituserprofile':
          return (<N12_EditUserProfileScreen {...screenProps} />)
        case 'orderhistory':
